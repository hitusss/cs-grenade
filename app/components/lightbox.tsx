	...
	return (
		<DialogPrimitive.Dialog open={true} onOpenChange={closeLightbox}>
			<DialogPrimitive.Portal>
				<DialogPrimitive.DialogOverlay className="fixed inset-0 z-50 justify-between bg-black/40 backdrop-blur-sm data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0" />
