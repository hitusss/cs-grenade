	...
	return (
		<DialogPrimitive.Dialog open={true} onOpenChange={closeLightbox}>
			<DialogPrimitive.Portal>
				<DialogPrimitive.DialogOverlay className="data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-50 justify-between bg-black/40 backdrop-blur-sm" />
				<DialogPrimitive.DialogContent
					ref={lightboxRef}
					className="data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] fixed top-1/2 left-1/2 z-50 flex h-full w-full -translate-x-1/2 -translate-y-1/2 items-center justify-between gap-4 p-4"
				>
					{images.length > 1 ? (
						<Button
							size="icon"
					...
					<DialogPrimitive.Close asChild>
						<Button
							variant="destructive"
							size="icon"
							className="absolute top-4 right-4 col-start-2 col-end-3 rounded-full"
						>
							<Icon name="x" />
