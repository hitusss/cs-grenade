...
import {
	getFilteredGrenadesWithChangesWithPagination,
	getFilteredGrenadeWithChangesCount,
...
export async function loader({ request }: Route.LoaderArgs) {
	...
	const total = await getFilteredGrenadeWithChangesCount({
		query,
		mapName: map,
		team,
		type,
	})
	const grenades = await getFilteredGrenadesWithChangesWithPagination({
		query,
		mapName: map,
		team,
		type,
