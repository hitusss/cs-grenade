...
import { type Route } from './+types/destinations-changes.ts'
				...
				<DropdownMenu>
					...
					<DropdownMenuContent align="end">
						...
						<DropdownMenuItem asChild>
							<Link
								to={`/map/${row.original.map.name}/${row.original.team}/${row.original.type}/${row.original.id}/admin/changes-request?${params}`}
...
export async function loader({ request }: Route.LoaderArgs) {
	...
	if (!sortResult.success) {
		...
		return redirect(
			`/admin/requests/destinations-changes?${searchParams.toString()}`,
		)
	}
...
export default function AdminRequestsDestinationsChangesRoute({
	loaderData,
