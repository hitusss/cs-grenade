				...
				<DropdownMenu>
					...
					<DropdownMenuContent align="end">
						...
						<DropdownMenuItem asChild>
							<Link
								to={`/map/${row.original.map.name}/${row.original.team}/${row.original.type}/${row.original.id}/admin/request?${params}`}
...
export async function loader({ request }: LoaderFunctionArgs) {
	...
	if (!sortResult.success) {
		...
		return redirect(`/admin/requests/destinations?${searchParams.toString()}`)
	}
